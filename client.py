...
def evaluate(resume: str,jd: str,api_key: str,model: str="gemini-2.5-flash") -> MatchResult:
    ...
    config=types.GenerateContentConfig(system_instruction=SYSTEM_PROMPT,response_mime_type="application/json",response_schema=MatchResult.model_json_schema(),temperature=0.0)
    last_error=None
    for attempt in range(3):
        try:
            ...
            if isinstance(exc,(json.JSONDecodeError,ValueError)):
                if attempt<2: time.sleep(0.25); continue
